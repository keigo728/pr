function wave = novelWave3t(Zobj, Nwave, initSet, fname)
global SVFOLDER
global SVF
...
%end
 ...
 wavefront = wavefront + N(cx/2 + 1 : cx/2 + cx, cy/2 + 1 : cy/2 + cy) + N(cx/2 + 2 : cx/2 + cx + 1, cy/2 + 2 : cy/2 + cy + 1) ...
                   + N(cx/2 + 2 : cx/2 + cx + 1, cy/2 + 1 : cy/2 + cy);
