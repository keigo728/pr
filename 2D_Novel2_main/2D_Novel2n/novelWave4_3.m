function wave = novelWave4_3(Zobj, Nwave, initSet, fname)
global SVFOLDER
global SVF
...
%end
 ...
 wavefront = wavefront + N(cx/2 + 1 : cx/2 + cx, cy/2 + 1 : cy/2 + cy) + N(cx/2 + 1 : cx/2 + cx, cy/2 + 5 : cy/2 + cy + 4) ...
                   + N(cx/2 + 5 : cx/2 + cx + 4, cy/2 + 1 : cy/2 + cy) + N(cx/2 + 5 : cx/2 + cx + 4, cy/2 + 5 : cy/2 + cy + 4);
