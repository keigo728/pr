function wave = novelWave4_2(Zobj, Nwave, initSet, fname)
global SVFOLDER
global SVF
...
%end
 ...
 wavefront = wavefront + N(cx/2 + 1 : cx/2 + cx, cy/2 + 1 : cy/2 + cy) + N(cx/2 + 1 : cx/2 + cx, cy/2 + 3 : cy/2 + cy + 2) ...
                   + N(cx/2 + 3 : cx/2 + cx + 2, cy/2 + 1 : cy/2 + cy) + N(cx/2 + 3 : cx/2 + cx + 2, cy/2 + 3 : cy/2 + cy + 2);
